...
Object.assign(window.LEXICON, {
  'loved': { headword: 'ἠγάπησεν (ēgapēsen)', translit: 'egapesen', lang: 'greek', glosses: ['loved'], morph: 'Verb aorist active', senses: ['divine love', 'sacrificial love'], refs: ['John 3:16'] },
  'world': { headword: 'κόσμος (kosmos)', translit: 'kosmos', lang: 'greek', glosses: ['world', 'universe'], morph: 'Noun masculine', senses: ['created order', 'humanity in rebellion'], refs: ['John 3:16'] },
  'born': { headword: 'γεννηθῇ (gennēthē)', translit: 'gennethe', lang: 'greek', glosses: ['born', 'begotten'], morph: 'Verb aorist passive subjunctive', senses: ['physical birth', 'spiritual regeneration'], refs: ['John 3:3'] }
});